const AboutUs = () => {
  return (
    <section className="container p-8 md:p-16">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-lg md:text-xl text-gray-600 mb-6">
          ...
          diagnostic services, empowering both doctors and patients with the
          data they need to make informed healthcare decisions.
        </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600">
                ...
                they receive the best possible care and attention throughout
            ...
            <div>
              ...
              <p className="text-gray-600">
                ...
                level of accuracy in our test results, ensuring patients can
            ...
            <div>
              ...
              <p className="text-gray-600">
                ...
                that every patient feels respected and supported throughout
                their visit.
              </p>
            </div>
          </div>
